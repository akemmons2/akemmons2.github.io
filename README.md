...
The Northwind Database was created and populated in PostgreSQL. Below are the screenshots of the database schemas and fact and dimension tables. The scripts for this project can be found here: $ git remote add origin [Northwind Data Mining & Statistical Analysis] (https://github.com/AKEMMONS2/Northwind_DataMining_StatisticalAnalysis.git){:target="_blank"}
